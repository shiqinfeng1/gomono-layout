...
func KratosMod() string {
	...
	if path, err := ModuleVersion("github.com/shiqinfeng1/gomono-layout/v2"); err == nil {
		// $GOPATH/pkg/mod/github.com/shiqinfeng1/gomono-layout@v2
		return filepath.Join(cachePath, path)
	}
	// $GOPATH/src/github.com/shiqinfeng1/gomono-layout
